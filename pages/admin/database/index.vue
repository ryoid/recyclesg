<template>
  <div>
    ...
    <div>
      ...
      <div class="shadow-lg">
        <DataTable :value="data" :lazy="true" scrollable :rowHover="true" v-model:selection="selectedCustomers"
          v-model:filters="filters" filterDisplay="menu" :loading="loading || pending" paginatorTemplate=""
...
onMounted(async () => {
  console.log('mounted', data.value?.length);
