      ...
      <div>
        ...
        <div class="container">
          ...
          <div class="grid grid-cols-1 place-items-end mt-6">
            <button type="submit" @click="submitForm" class="text-white bg-blue-700 hover:bg-blue-800 font-medium rounded-md text-sm px-5 py-2.5 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Update Entry</button>        
          </div>
        </div>
    </div>
  </div>
