        ...
        <div>
            ...
            <form>
                <div>
                    ...
                    <InputText :useGrouping="false" v-model="form.phone" required class="w-[500px] form-control"
                ...
                <div>
                    ...
                    <div class="inline">
                        ...
                        <InputText :useGrouping="false" v-model="form.postal" required class="w-[300px] form-control"
                            id="postal" pattern="[0-9]{6}" title="Postal Code" />
                ...
                <div>
                    ...
                    <FileUpload name="demo[]" url="./upload" :multiple="true" accept="image/*" ref="fileUploadRef"
                        :fileLimit="1" />
                    <div>
